...
import { Steps, useDisclosure, Dialog, Portal } from "@chakra-ui/react";
  ...
  (props, accordionButtonRef) => {
    ...
    return (
      <>
        ...
        <Dialog.Root
          finalFocusEl={() => (focusOutside ? (accordionButtonRef as RefObject<FocusableElement | null>) : viewMoreButtonRef).current}
          open={isOpen}
          onOpenChange={e => {
            if (!e.open) {
